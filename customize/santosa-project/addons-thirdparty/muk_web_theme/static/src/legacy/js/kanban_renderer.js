...
KanbanRenderer.include({
    ...
    on_attach_callback() {
        ...
        super.on_attach_callback.apply(this, arguments);
    },
    on_detach_callback() {
        var self = this;
        ...
        super.on_detach_callback.apply(this, arguments);
    },
    addQuickCreate() {
    ...
    updateColumn(localID) {
        ...
        return super.updateColumn.apply(this, arguments)
    ...
    _renderGrouped(fragment) {
        ...
        super._renderGrouped.apply(this, [newFragment]);
    ...
    _renderView() {
        var self = this;
        return super._renderView.apply(this, arguments).then(function () {
